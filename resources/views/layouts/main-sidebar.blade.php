				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='chart-morris') }}">الفواتير المدفوعه</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-flot') }}">الفواتير الغير المدفوعه</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-chartjs') }}"> الفواتير المدفوعه جزئيا</a></li>
