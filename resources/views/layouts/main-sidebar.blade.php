				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ route('paid') }}">الفواتير المدفوعه</a></li>
							<li><a class="slide-item" href="{{ route('unpaid') }}">الفواتير الغير المدفوعه</a></li>
							<li><a class="slide-item" href="{{route('partial_paid') }}"> الفواتير المدفوعه جزئيا</a></li>
