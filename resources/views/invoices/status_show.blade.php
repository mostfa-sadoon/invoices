                    ...
                    <form action="{{ route('status_update',[$invoice->id]) }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" value="{{ $invoice->discount }}" class="form-control form-control-lg" id="Discount" name="Discount"
                        ...
                        <label for="inputName" class="control-label">حاله الدفع</label>
                                <select name="status" id="status" class="form-control" onchange="myFunction()">
                                    ...
                                    <option value="Partially paid">مدفوع جزئيا</option>
                                </select>
                        </div>
                        <div class="col">
                                <label>تاريخ الدفع</label>
                                <input class="form-control fc-datepicker" name="payment_Date" placeholder="YYYY-MM-DD" value="{{$invoice->due_date}}"
                                    type="text" readonly>
                        </div>
